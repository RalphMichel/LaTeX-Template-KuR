...
%draft,
	...
	9.5pt,					% Schriftgrï¿½sse
%	twoside,				% Zwei-Seitig 
%	openright,			 	% Neues Kaptiel auf rechter Seite
	notitlepage,		 	% Keine Standard-Titelseite
	parskip=half,	  		% set paragraph skip to half of a line
	listof=entryprefix, 	% Prï¿½fix (Abb.)in den Verzeichnissen
]{scrreprt}			    	% KOMA-script Klasse

%------------------------------------------


%\raggedbottom ----fï¿½r report schon voreingestellt
...
% TODO PDF Titel           				
pdftitle = {PDF Titel einfï¿½gen},	  
% TODO PDF Autor 									
pdfauthor = {Vorname Nachname}, 
% TODO PDF subject       					 			
pdfsubject = {PDF Subject einfï¿½gen},  
% Color of Links      			   	
linkcolor = {linkcolor},  
% Color of Cite-Links            				
citecolor = {linkcolor},  
...
% Kontrolle ï¿½ber Verzeichnistiefe
\usepackage{tocvsec2}
...
%Abstï¿½nde im Inhaltsverzeichnis 				
\RedeclareSectionCommand[
tocbeforeskip = 7pt]{chapter} 
				

%--------Formatierung der ï¿½berschriften------------------------
...
% ------Abstï¿½nde Überschriften definieren-----------------------
...
% Silbentrennung mit Wï¿½rter ï¿½ ï¿½ ï¿½		
\usepackage[T1]{fontenc}	

% deutsche Anfï¿½hrungszeichen				  	
\usepackage[autostyle=true,german=quotes]{csquotes}

% Zusï¿½tzliche Symbole 
\usepackage{textcomp}

% Bessere Auflï¿½sung fï¿½r T1-Schriften						 	
\usepackage{ae}		

% Sans Serif familiy ausgewï¿½hlt
...
% Einfache Anpassung fï¿½r Kopf- und Fusszeile
\usepackage{fancyhdr}						   	

% Farbanpassung fï¿½r Kopf- und Fusszeile
\usepackage{etoolbox}	
...
% fï¿½r command textblock, genaue Positionierung von Textabschnitten		
...
% Blau fï¿½r Web und CD-Version		
%\definecolor{linkcolor}{rgb}{0,0,0.8} 

% Schwarz fï¿½r die Druckversion 				
...
% Neue Farbe fï¿½r Kopfzeile
\patchcmd{\@fancyhead}{\rlap}{\color{bfhgrey}\rlap}{}{}	

% Neue Farbe fï¿½r Fusszeile		
...
% Aktivieren fÃ¼r Titelseite ohne Bild
%\include{vorspann/titelseite_ohne_bild}	

% Titelseite mit Bild definieren - Aktivieren fï¿½r Titelseite mit Bild			
\include{vorspann/titelseite_mit_bild}		

% Layout mit Seitennummerierung/nur fusszeile keine kopfzeile wird gedruckt		
\pagestyle{plain}	

% Aktivieren fï¿½r Vorspann Versionen													
\include{vorspann/version}		
...
% TODO Abkï¿½rzungsverzeichnis und Glossar JA/NEIN										
...
\include{kapitel/vorbemerkungen}
\include{kapitel/identifikation}
\include{kapitel/werkbeschreibung}
\include{kapitel/zustandsbeschreibung}
\include{kapitel/schadensursachen}
\include{kapitel/konzeptkonservierung}
\include{kapitel/durchgefuehrtemassnahmen}
...
\include{Kapitel/selbststaendig}
